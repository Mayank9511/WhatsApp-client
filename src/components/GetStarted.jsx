...
const socket = io("https://communications-organized-matched-manchester.trycloudflare.com");
...
function GetStarted() {
  ...
  socket.on("hello", (id) => {
    ...
    try {
      ...
      setLoader(false);
      alert("Some issue occurred, please try again or contact the owner.")
    }
  });
      ...
      <div className="w-full flex flex-col md:flex-row gap-8 border-t-[1px] border-[#a1b562]">
        <div className="w-full md:w-1/2">
          ...
          <input
            ...
            className="w-full md:w-3/4 h-[10vw] md:h-[5vw] p-[2vw] md:p-[1.5vw] mt-[20px] rounded-xl"
          />
          <button
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <div className="min-w-[320px] h-[320px] m-[5vw] flex justify-center items-center md:ml-[4vw] rounded-3xl bg-[#fff]">
            {loader && (
              <Box>
                <CircularProgress />
              </Box>
