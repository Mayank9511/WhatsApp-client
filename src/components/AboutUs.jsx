    ...
    >
      ...
      <div className="border-t-[1px] border-zinc-800 my-10 md:mt-10 lg:mt-10 flex flex-col md:flex-row justify-between items-center px-6 md:px-10">
        <div className="w-full mt-10 md:pt-0 md:w-3/5 px-10 md:px-10 text-sm md:text-base ">
          This app allows you to create your own WhatsApp Assistant that can
          automatically respond to your messages based on your needs, powered by
          AI. For example, if you're in an exam or a meeting, you can set the
          time when you'll be available, and anyone who messages you might
          receive a reply like, "I'm currently in a meeting, will get back to
          you shortly." The responses will adapt based on the incoming messages,
          as they are dynamically generated by AI.
        </div>
